...
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Abrir p\u00e1gina del v\u00eddeo";a.T().ea("kevlar_miniplayer_expand_top")&&(c="ytp-miniplayer-button-top-left",d={D:"svg",U:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},S:[{D:"g",U:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},S:[{D:"g",U:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},S:[{D:"path",U:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Expandir");g.V.call(this,{D:"button",Ba:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],U:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},S:[d]});this.G=a;this.Na("click",this.onClick,this);this.Oa("title",g.EM(a,e,"i"));g.wi(this,g.bN(b.fc(),this.element))},Y3=function(a){g.V.call(this,{D:"div",
...
g.k.show=function(){this.Ke=new g.Zm(this.uu,null,this);this.Ke.start();if(!this.hj){this.tooltip=new g.BP(this.player,this);g.H(this,this.tooltip);g.YL(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.tc=new g.XM(this.player);g.H(this,this.tc);this.Qk=new g.V({D:"div",K:"ytp-miniplayer-scrim"});g.H(this,this.Qk);this.Qk.xa(this.element);this.N(this.Qk.element,"click",this.OI);var a=new g.V({D:"button",Ba:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Cerrar"},S:[g.hK()]});
...
this.Ij);this.Ij.xa(this.Qk.element);this.yd=new g.DO(this.player,this);g.H(this,this.yd);g.YL(this.player,this.yd.element,4);this.kx=new g.V({D:"div",K:"ytp-miniplayer-buttons"});g.H(this,this.kx);g.YL(this.player,this.kx.element,4);a=new g.V({D:"button",Ba:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Cerrar"},S:[g.hK()]});g.H(this,a);a.xa(this.kx.element);this.N(a.element,"click",this.Ai);a=new g.V({D:"button",Ba:["ytp-miniplayer-replay-button","ytp-button"],U:{"aria-label":"Cerrar"},
